...
if [ "${NETDATA_BUILD_WITH_DEBUG}" -eq 0 ]; then
  export CFLAGS="-ffunction-sections -fdata-sections -static -O2 -funroll-loops -DNETDATA_SKIP_IF_NOT_COLLECT=1 -I/openssl-static/include -I/libnetfilter-acct-static/include/libnetfilter_acct -I/usr/include/libmnl -pipe"
else
  export CFLAGS="-static -O1 -pipe -ggdb3 -Wall -Wextra -Wformat-signedness -DNETDATA_INTERNAL_CHECKS=1 -DNETDATA_SKIP_IF_NOT_COLLECT=1 -I/openssl-static/include -I/libnetfilter-acct-static/include/libnetfilter_acct -I/usr/include/libmnl"
fi
